...
namespace AppDash.Server.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PluginKey = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueIdentifier = table.Column<string>(nullable: false),
                    Key = table.Column<string>(nullable: false),
                    TileFactory = table.Column<string>(nullable: true),
                    FactoryIndex = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
