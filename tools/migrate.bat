...
set MIGRATIONS_PATH=%~dp0..\src\AppDash\AppDash.Server.Data\Migrations
...
rem Move the current directory to the parent directory which is the data project that contains AppDashContext.cs which it will need for the command below
cd %MIGRATIONS_PATH%\..\
